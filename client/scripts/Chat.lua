...
Chat.Init = function()
    ...
    local function CreateChat(Text, TableIndex, colour)
    ...
    teverse.networking:on("message", function(text, SentColour)
        ...
        CreateChat(text, #ChatScrollFrame.children, colour.rgb(SentColour.r, SentColour.g, SentColour.b))
    end)
